...
if (jQuery("#apex-radialbar-chart").length) {
	options = {
		...
		colors: ["#ff9900", "#ff7750", "#6ce6f4", "#1ee2ac"]
	};
...
if (jQuery("#apex-pie-chart").length) {
	options = {
		...
		colors: ["#ff9900", "#ff7750", "#6ce6f4", "#1ee2ac", "#c8c8c8"],
		responsive: [{
			breakpoint: 480,
			options: {
				chart: {
...
if (jQuery("#am-simple-chart").length && am4core.ready(function() {
		...
		e.colors.list = [am4core.color("#ff9900")], e.data = [{
			country: "USA",
			visits: 2025
		}, {
			country: "China",
		...
		e.colors.list = [am4core.color("#ff9900")], e.exporting.menu = new am4core.ExportMenu;
		var t = e.xAxes.push(new am4charts.CategoryAxis);
		...
		n.name = "Expenses", n.dataFields.valueY = "expenses", n.dataFields.categoryX = "year", n.stroke = am4core.color("#ff9900"), n.strokeWidth = 3, n.propertyFields.strokeDasharray = "lineDash", n.tooltip.label.textAlign = "middle";
		...
		e.colors.list = [am4core.color("#ff9900"), am4core.color("#ff9900"), am4core.color("#1ee2ac")], e.data = [{
			year: "2016",
			europe: 2.5,
			namerica: 2.5,
			asia: 2.1,
		...
		e.colors.list = [am4core.color("#ff9900"), am4core.color("#ff9900")], e.data = [{
			year: "2005",
			income: 23.5,
			expenses: 18.1
		}, {
		...
		e.colors.list = [am4core.color("#ff9900")], e.data = function() {
			var e = [],
				t = new Date;
		...
		a.category = "NW", a.endCategory = "NW", a.axisFill.fill = am4core.color("#ff9900"), a.axisFill.fillOpacity = .3;
		var n = t.axisRanges.create();
		n.category = "N", n.endCategory = "N", n.axisFill.fill = am4core.color("#ff9900"), n.axisFill.fillOpacity = .3;
		...
		t.colors.list = [am4core.color("#ff9900"), am4core.color("#fbc647"), am4core.color("#ff7750"), am4core.color("#6ce6f4"), am4core.color("#1ee2ac"), am4core.color("#c8c8c8")], t.dataFields.value = "litres", t.dataFields.category = "country"
	}), jQuery("#am-layeredcolumn-chart").length && am4core.ready(function() {
		am4core.useTheme(am4themes_animated);
		var e = am4core.create("am-layeredcolumn-chart", am4charts.XYChart);
		e.colors.list = [am4core.color("#1ee2ac"), am4core.color("#ff9900")], e.numberFormatter.numberFormat = "#.#'%'", e.data = [{
			country: "USA",
			year2004: 3.5,
			year2005: 4.2
		}, {
		...
		ykeys: ["y", "z", "a"],
		labels: ["Y", "Z", "A"],
		barColors: ["#ff9900", "#1ee2ac", "#1ee2ac"],
...
if (jQuery("#home-chart-03").length) {
	options = {
		...
		colors: ["#ff9900", "#6ce6f4", "#a09e9e", "#fbc647"],
		responsive: [{
			breakpoint: 480,
			options: {
				chart: {
...
jQuery("#home-chart-04").length && am4core.ready(function() {
	...
	e.colors.list = [am4core.color("#ff9900")];
	...
	e.colors.list = [am4core.color("#ff9900"), am4core.color("#ff7750")];
...
range0.axisFill.fill = am4core.color("#ff9900");
